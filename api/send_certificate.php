...
function generateCertificatePDF($name, $sessionId, $language, $affiliation) {
    ...
    $texts = [
        ...
        'fr' => ['title' => 'CERTIFICAT DE PARTICIPATION', 'text1' => 'Certifie que', 'text2' => 'a participé au projet de recherche', 'text3' => 'Validation Computationnelle des Concepts de l\'Axiodynamique', 'text4' => 'Affiliation :', 'text5' => 'ID Session :', 'text6' => 'Date :', 'text7' => 'Projet OSF :', 'signature' => 'Alan Kleden, Chercheur'],
